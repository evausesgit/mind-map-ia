...
def build_nav(maps, current_output, topics=None):
    ...
    return (
        ...
        f'<svg width="44" height="26" viewBox="0 0 56 32" fill="none" xmlns="http://www.w3.org/2000/svg">'
        f'<!-- tree lines -->'
        f'<line x1="5" y1="16" x2="17" y2="8"  stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="5" y1="16" x2="17" y2="24" stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="17" y1="8"  x2="30" y2="4"  stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="17" y1="8"  x2="30" y2="13" stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="17" y1="24" x2="30" y2="19" stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="17" y1="24" x2="30" y2="28" stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="30" y1="4"  x2="45" y2="8"  stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="30" y1="13" x2="45" y2="8"  stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="30" y1="19" x2="45" y2="24" stroke="#E74C3C" stroke-width="1.5"/>'
        f'<line x1="30" y1="28" x2="45" y2="24" stroke="#E74C3C" stroke-width="1.5"/>'
        f'<!-- crossing lines -->'
        f'<line x1="17" y1="8"  x2="30" y2="19" stroke="#E74C3C" stroke-width="1" stroke-opacity="0.35"/>'
        f'<line x1="17" y1="24" x2="30" y2="13" stroke="#E74C3C" stroke-width="1" stroke-opacity="0.35"/>'
        f'<line x1="30" y1="4"  x2="45" y2="24" stroke="#E74C3C" stroke-width="1" stroke-opacity="0.25"/>'
        f'<line x1="30" y1="28" x2="45" y2="8"  stroke="#E74C3C" stroke-width="1" stroke-opacity="0.25"/>'
        f'<!-- nodes -->'
        f'<circle cx="5"  cy="16" r="4"   fill="white"/>'
        f'<circle cx="17" cy="8"  r="3.2" fill="white"/>'
        f'<circle cx="17" cy="24" r="3.2" fill="white"/>'
        f'<circle cx="30" cy="4"  r="2.8" fill="white"/>'
        f'<circle cx="30" cy="13" r="2.8" fill="white"/>'
        f'<circle cx="30" cy="19" r="2.8" fill="white"/>'
        f'<circle cx="30" cy="28" r="2.8" fill="white"/>'
        f'<circle cx="45" cy="8"  r="2.5" fill="#E74C3C"/>'
        f'<circle cx="45" cy="24" r="2.5" fill="#E74C3C"/>'
        f'</svg>'
        f'</a>'
